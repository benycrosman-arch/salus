    ...
    <div className="grain-overlay min-h-screen bg-[#faf8f4] text-[#1a3a2a] overflow-hidden">
      ...
      <section id="planos" className="relative py-24 sm:py-32 bg-[#f0ebe3]">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          {/* NUTRI COMMISSION ROW — referral channel with tiered rates */}
          <div className="mt-12 max-w-5xl mx-auto">
            <ScaleIn delay={0.32}>
              <div className="rounded-3xl bg-gradient-to-br from-[#1a3a2a] to-[#0f2519] p-8 sm:p-10 ring-1 ring-white/5">
                <div className="flex flex-col sm:flex-row items-start gap-8">
                  <div className="flex-1">
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2.5 max-w-md text-xs text-white/60">
                      <div className="flex items-center gap-2">
                    ...
                    <Link href="/onboarding-nutri">
                      <Button className="mt-6 h-12 rounded-full bg-[#c8a538] font-semibold text-[#1a3a2a] hover:bg-[#c8a538]/90 px-6">
                        {tPricing('nutri.cta')}
                        <ArrowRight className="w-4 h-4 ml-2" />
                      </Button>
                    </Link>
                    ...
                    <div className="rounded-2xl bg-white/[0.03] ring-1 ring-white/10 divide-y divide-white/5">
                      {[
                        ...
                        <div key={p} className="flex items-center justify-between px-4 py-2 text-xs">
                          <span className="text-white/60">{tp('nutri.ladderPatients', { count: p })}</span>
                          <span className="font-bold text-white">{r}</span>
                        </div>
                      ))}
                    </div>
                    <p className="mt-3 text-[10px] text-white/40 leading-relaxed">{tp('nutri.ladderNote')}</p>
                  </div>
                </div>
              </div>
            </ScaleIn>
