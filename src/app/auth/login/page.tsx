      ...
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-foreground font-sans">Bem-vindo de volta</h1>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/forgot-password" className="text-xs text-primary hover:underline font-body">
                    Esqueceu a senha?
                  </Link>
                </div>
                <div className="relative">
                  <Input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••"
                    ...
                    required className="h-12 pr-11 font-body" />
