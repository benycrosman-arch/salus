...
import { Loader2, Send, Stethoscope, MessageCircle, ArrowRight } from "@/components/icons"
      ...
      <div className="min-h-[40vh] flex items-center justify-center px-4 py-12">
        <Card className="border-0 shadow-md max-w-md w-full p-8 text-center space-y-5">
          ...
          <div className="space-y-2">
            <h2 className="text-xl font-bold font-sans text-[#1a3a2a]">Sem nutricionista vinculado</h2>
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-260px)] lg:h-[calc(100vh-220px)]">
      <div className="flex items-center gap-3 pb-4 border-b border-[#e4ddd4]">
        ...
        <div>
          <h2 className="text-lg font-bold text-[#1a3a2a] font-sans leading-tight">{nutriName}</h2>
